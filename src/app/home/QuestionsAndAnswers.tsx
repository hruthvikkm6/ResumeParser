...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          AIResume saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets AIResume apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than AIResume, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, AIResume
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. AIResume is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, AIResume intentionally only offers
  ...
  {
    question: "Q3. Who created AIResume and why?",
    answer: (
      <p>
        AIResume was created by{" "}
        <Link href="https://github.com/hruthvikkm6/ResumeParser">Hruthvik</Link> as
        ...
        that led to AIResume, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that AIResume can help
  ...
  {
    question: "Q4. How can I support AIResume?",
    answer: (
      <>
        <p>
          The best way to support AIResume is to share your thoughts and
          feedback with us to help further improve it. You can send us an email
          at{" "}
          <Link href="mailto:hello@airesume.com">hello@airesume.com</Link>{" "}
          or{" "}
          <Link href="https://github.com/hruthvikkm6/ResumeParser/issues/new">
            open an issue
          </Link>{" "}
        ...
        <p>
          Another great way to support AIResume is by spreading the words.
          ...
          by{" "}
          <Link href="https://github.com/hruthvikkm6/ResumeParser">
