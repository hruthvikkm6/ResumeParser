  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the AIResume
      ...
      <Paragraph>
        And that is everything about the AIResume parser algorithm :)
      </Paragraph>
      <Paragraph>
        Written by <Link href="https://github.com/hruthvikkm6/ResumeParser">Hruthvik</Link> on
        June 2023
      </Paragraph>
    </article>
  );
